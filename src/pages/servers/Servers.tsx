...
import { Storage, Share, MoreHoriz, Add, Delete } from '@mui/icons-material';
  ...
  return (
    ...
    >
      <span className="inline-flex items-center font-bold ">
        <div className="ml-3 mr-6 inline-flex h-12 w-12 items-center rounded-xl bg-purple">
          <Storage style={{}} className="m-auto" />
        </div>
        {props.serverName}
      </span>
      <span className="text-black-dim">Vmess</span>
  ...
  return (
    <section className="">
      ...
      <div className="flex flex-row justify-center">
        <ServerItem serverName="New Server"></ServerItem>
      </div>
      ...
      <Button onClick={() => serverData()}>test</Button>
    </section>
  );
};
